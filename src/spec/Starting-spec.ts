...
const resize_url2: string | URL = "http://localhost:5001/resize?image=p2&width=350&height=240";
const resize_url3: string | URL = "http://localhost:5001/resize?image=p2";
const resize_url4: string | URL = "http://localhost:5001/resize?image=p2&width=350p&height=240";
const resize_url5: string | URL = "http://localhost:5001/resize?image=p2&width=350";
