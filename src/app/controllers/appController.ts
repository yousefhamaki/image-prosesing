...
exports.upload = async (req: Request, res: Response) => {
  ...
  const image: string | qs.ParsedQs | string[] | qs.ParsedQs[] | undefined =
    req.query.image;
  const width: string | qs.ParsedQs | string[] | qs.ParsedQs[] | undefined =
    req.query.width;
  const height: string | qs.ParsedQs | string[] | qs.ParsedQs[] | undefined =
    req.query.height;
